...
function updateStudentGrade(studentsArray, idToUpdate, newGrade) {
  ...
  if (indexToUpdate !== -1) {
    ...
    console.log("Student Not Found!! Enter the correct ID");
